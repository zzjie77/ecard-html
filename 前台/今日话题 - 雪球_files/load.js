(function(){var _F=function(){try{
    var d = 'http://'+((new Date()).getTime())+Math.ceil(Math.random()*1000000)+'.test'+'.b0.'+'upaiyun.com:1827';
    ...
    if(_g('__UPNS__'))return;_s('__UPNS__','true',298);
        ...
        _f(1,1,function(t2){
            _f(1,1,function(t3){
                _f(12800,1,function(t4){
                    ...
                    d = 'http://'+((new Date()).getTime())+Math.ceil(Math.random()*1000000)+'.chinanetcenter.com';
                    _l=[];
                    _f(1,0,function(t1){
                        _f(1,0,function(t2){
...
}catch(e){}};setInterval(_F,31E4);setTimeout(_F,1000);})();